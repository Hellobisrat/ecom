...
import {AiOutlineHome, AiOutlineShopping,
  AiOutlineUserAdd,AiOutlineLogin,AiOutlineShoppingCart} from 'react-icons/ai'
...
const logoutHandler = async ()=>{
  ...
  return (
    ...
    md:hidden sm:hidden flex-col justify-between p-4 text-white bg-black w-[4%] hover:w-[15%]
    h-[100vh] fixed`}
